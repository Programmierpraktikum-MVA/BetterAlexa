...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      {/* <main className="flex h-screen flex-col items-center bg-black text-white font-['Helvetica'] text-sm">
        <div className="flex bg-green-500 h-16 fixed items-center top-0 right-0">
          luisaugsburg@gmail.com
          <button className="mx-5 border-white border-2 rounded-3xl">
            <p className="mx-4 my-2">Sign Out</p>
          </button>
        </div>
        <div className="flex flex-col items-center border-white border-2 h-screen w-2/5">
          <h1 className="mt-16 text-3xl font-bold">Better Alexa</h1>    
          <div className="bg-white  w-3/5 rounded-3xl">
            <div className="text-black bg-green-500 h-10 my-6 mx-6">
              Halo
            </div>
          </div>
        </div>
      </main> */}
      <main className="flex h-screen flex-col items-center text-white/70 font-['Helvetica'] text-sm bg-gradient-to-b from-cyan-500 from-0% via-blue-500 via-35% to-black to-100%">
      {/* <main className="flex h-screen flex-col items-center  text-white font-['Helvetica'] text-sm bg-white"> */}
