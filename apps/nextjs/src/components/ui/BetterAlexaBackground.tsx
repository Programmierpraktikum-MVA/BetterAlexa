...
export default function BetterAlexaBackground({children} : { children: ReactNode }) {
  ...
  return <>
      {colorTheme === "dark"? 
      (
       <main className="fixed overflow-y-scroll inset-0 h-screen bg-blue-500 transition-colors duration-1000">
        ...
        : 
        (
        <main className="fixed overflow-y-scroll inset-0 h-screen bg-gray-900 transition-colors duration-1000">
          <div className="flex flex-col items-center font-['Helvetica'] text-sm text-white/100">
            <div className="fixed left-0 top-0 flex h-16 items-center">
