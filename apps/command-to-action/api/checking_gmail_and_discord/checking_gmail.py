# for gmail https://github.com/abhishekchhibber/Gmail-Api-through-Python/blob/master/gmail_read.py
...
- Mark the messages as Read - so that they are not read again   #for demosntration purposes it is commented out => it is the last line of code
'''
...
def retrieve_all_gmail_messages():
	...
	user_id =  'dummybetteralexa@gmail.com'
	label_id_one = 'INBOX'
	label_id_two = 'UNREAD'
