...
module.exports = createCommand("connect",
    ...
    async message => {
        ...
        message.channel.send(env.parsed.WARNING_MESSAGE);
        ...
        // Make voice streams for voice text-commands
        ...
        message.client.voiceConnections.set(message.guild.id,
            createVoiceConnectionData(connection, null, member.user, message.channel));
